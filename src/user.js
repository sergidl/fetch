...
document.addEventListener("DOMContentLoaded", () => {
	...
	createAccountForm.addEventListener("submit", e => {
		...
		console.log(createAccountForm.username.value + ' register ' + createAccountForm.password.value);

		postUser(createAccountForm.username.value, createAccountForm.password.value);
		e.preventDefault();
